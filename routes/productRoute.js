...
//     try{
//         con.query(`SELECT * FROM Products WHERE product_id=${req.params.product_id}`, (err, results) =>{
//             if(err) throw err;
//             res.send(results);
//         });
//     } catch (error) {
...
//     try{
//         con.query(`DELETE FROM Products WHERE product_id=${req.params.product_id}`, (err, results) =>{
//             if(err) throw err;
//             res.send(results);
//         });
//     } catch (error) {
